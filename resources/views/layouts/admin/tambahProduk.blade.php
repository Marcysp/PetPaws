    ...
    <form action="/produk/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex">
            <div class="w-2/5 mx-6">
                ...
                <input type="file" name="img" class="cursor-pointer block w-full rounded-md border-0 py-1.5 text-slate-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-400 sm:text-sm sm:leading-6 mr-2 outline-none px-3" br
                required><br>
            ...
            <div class="mx-10 w-3/5">
                ...
                <textarea name="deskripsi" cols="30" rows="5" class="block w-full rounded-md border-0 py-1.5 text-slate-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-400 sm:text-sm sm:leading-6 mr-2 outline-none px-3"></textarea>
