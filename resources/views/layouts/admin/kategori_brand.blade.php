                ...
                <div class="modal-content-manual" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="text-2xl mb-4">Edit Kategori Brand</h5>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('brand.update', $b->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="nama_brand" value="{{$b->nama_brand}}" class="form-control block w-1/2 rounded-md border-0 py-1.5 text-slate-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-400 sm:text-sm sm:leading-6 mr-2 outline-none px-3"><br>
                                </div>
